/// Chứa các string cố định (label, message)
class AppStrings {
  //Splash
  static const String appName = "Cổng thông tin nhân viên";
  static const String welcomeMessage = "Chào mừng bạn đến với Á Châu – nơi hội tụ tất cả thông tin cần thiết cho nhân viên, được thiết kế đơn giản, trực quan và dễ sử dụng.";
  static const String getstartedButton = "Bắt đầu";
  //Onboarding
  static const String skipButton = "Bỏ qua";
  static const String nextButton = "Tiếp";
  //Auth
  // static const String helloTitle = "Xin chào!";
  ...
  static const String forgetPasswordButton = "Quên mật khẩu?";
  static const String newAccountTitle = "Tài khoản mới";
